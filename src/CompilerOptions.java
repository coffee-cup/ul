...
public class CompilerOptions {
	...
	public static CompilerOptions parseCompilerArgs(String[] args) {
		...
		ParseCmd cmd = new ParseCmd.Builder().help(usage).parm("-o", "<stdout>").parm("-s", "0").rex("^[01]{1}$")
				.msg("enter 0 or 1; other values are invalid").parm("-d", "0").rex("^[01]{1}$")
				.msg("enter 0 or 1; other values are invalid").build();
